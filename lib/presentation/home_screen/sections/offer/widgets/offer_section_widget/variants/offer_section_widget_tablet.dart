...
class OfferSectionWidgetTablet extends StatefulWidget {

  final OfferSectionObject data;
  final VoidCallback onPressed;

  const OfferSectionWidgetTablet({
    super.key,
    required this.data,
  ...
  @override
  State<OfferSectionWidgetTablet> createState() => _OfferSectionWidgetTabletState();
}

class _OfferSectionWidgetTabletState extends State<OfferSectionWidgetTablet> with SingleTickerProviderStateMixin{
